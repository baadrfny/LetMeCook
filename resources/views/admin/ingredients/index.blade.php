        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 border border-gray-700">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-3xl font-bold text-orange-500">Ingredients Management</h1>
                </div>

                <!-- Add New Ingredient Form -->
                <div class="mb-8 p-4 bg-gray-700 rounded-lg">
                    <h2 class="text-xl font-semibold text-gray-300 mb-4">Add New Ingredient</h2>
                ...
                <!-- Ingredients List -->
                <div class="space-y-4">
                    <h2 class="text-xl font-semibold text-gray-300 mb-4">Existing Ingredients</h2>
                    
                    @if($ingredients->count() > 0)
                        @foreach($ingredients as $ingredient)
                        <div class="flex items-center justify-between p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition">
                            <div class="flex-1">
                                <h3 class="text-lg font-medium text-black">{{ $ingredient->name }}</h3>
                                <p class="text-gray-400 text-sm">ID: {{ $ingredient->id }}</p>
                            </div>
